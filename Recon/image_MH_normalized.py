...
saved_model_path = '/home/zhihan/data/model/saved_models_unet/xcat/512/multihead/normalized/unet_e1000_t5_v5_lr0.0002_512x512_ct_ssim20240313-131653'
...
def resize_img(im, size):
    reimg = cv2.resize(im, size, interpolation=cv2.INTER_LINEAR)
    reimg = reimg * (np.shape(im)[0]/size[0])
    return reimg
